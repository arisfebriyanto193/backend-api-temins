...
foreach ($rows as $row) {
    ...
    if (strpos($param_name, 'hujan') !== false || strpos($param_name, 'curah') !== false) {
        $code = 'ch';
    } else if (strpos($param_name, 'arah') !== false) {
        $code = 'aa';
    } else if (strpos($param_name, 'kecepatan') !== false || (strpos($param_name, 'angin') !== false && strpos($param_name, 'arah') === false)) {
        $code = 'ka';
    }
