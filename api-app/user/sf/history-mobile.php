...
while ($row = mysqli_fetch_assoc($q_sensor)) {
    $style = getSensorConfig($row['label']);
...
/* ===============================
   6. YEAR RANGE
================================ */
// Jika mau dinamis, tinggal buka query ini
/*
$q_range = mysqli_query($conn, "
    SELECT MIN(recorded_at) AS first_date, MAX(recorded_at) AS last_date
    FROM sensor_logs
